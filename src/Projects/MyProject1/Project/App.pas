...
uses
  System.Classes,
  System.SysUtils,
  {$INCLUDE '../Common/OpenGL.inc'}
  Chelco.Classes,
  Chelco.App;

type
  TChelcoApp = class(TApplication)
  private
    FShader: IShader;
...
procedure TChelcoApp.Initialize;
var
...
begin
  ...
  Data := TAssets.Load('C:\Users\nerib\OneDrive\Imágenes\neri.jpg');
...
procedure TChelcoApp.KeyDown(const AKey: Integer; const AShift: TShiftState);
begin
...
procedure TChelcoApp.Shutdown;
begin
  glDeleteTextures(1, @FTexture1);
  glDeleteTextures(1, @FTexture2);
end;

procedure TChelcoApp.Update(const ADeltaTimeSec, ATotalTimeSec: Double);
var
...
begin
  ...
  Rotation.InitRotationZ(ATotalTimeSec * Radians(80));
  Translation.InitTranslation(-1, 1, 0);
  Transform := Rotation * Translation;
  //Transform := 1 * Translation;
