...
procedure TMyApp.KeyDown(const AKey: Integer; const AShift: TShiftState);
begin
...
procedure TMyApp.Update(const ADeltaTimeSec, ATotalTimeSec: Double);
var
